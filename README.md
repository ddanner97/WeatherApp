...
This project is a front-end application built using **React.js** and **sass** while leveraging OpenWeatherMap's free api's for current weather as well the 5 day forecast. My main goal with this project was to increase my understanding of React while practicing retrieving data from an external API.
